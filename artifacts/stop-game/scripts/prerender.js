...
const pages = [
  {
    ...
    content: `
      <main>
        ...
        <p>La gracia del juego está en la variedad. Una letra puede parecer fácil hasta que aparece una categoría complicada; otra puede obligarte a recordar una palabra que hacía años que no utilizabas. Por eso una partida de STOP sirve tanto para competir como para aprender vocabulario y descubrir palabras nuevas.</p>
        <h2>¿Cómo se juega?</h2>
        <ol><li>Entra en una partida y revisa las categorías de la ronda.</li><li>Cuando aparece la letra, busca una palabra que empiece por ella para cada categoría.</li><li>Escribe tus respuestas mientras el contador está activo.</li><li>Pulsa STOP cuando hayas terminado o espera a que finalice el tiempo.</li><li>Compara las respuestas y consulta la puntuación de la ronda.</li></ol>

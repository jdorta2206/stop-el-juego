const en = {
  ...
  premium: {
    ...
    features: [
      "Advanced stats and full match history",
      "Golden frame and exclusive avatars in the ranking",
      "Unlimited private rooms with custom settings",
      "All category packs included (Science, History and future ones)",
    ],
  ...
  streamer: {
    directoryTitle: "Live right now",
    directorySubtitle: "Public streamer rooms",
    empty: "Nobody is live right now",
    emptyHint: "Got a room? Toggle streamer mode to show up here.",
    createOwn: "Create my room",
    watch: "Watch",
    otherLanguages: "Other languages",
    homeCard: "Live now",
    homeCardSub: "Watch streamer games live",
  },

  impossible: {
    title: "Impossible Word",
    subtitle: "One brutal letter · 60s · 1 try",
    homeCard: "Impossible Word",
    homeCardSub: "Dare to try today's challenge?",
    letterLabel: "Letter",
    categoryLabel: "Category",
    rules: "You have 60 seconds to type ONE word that starts with this letter and fits the category. One try, once a day.",
    start: "Start challenge",
    submit: "Submit",
    surrender: "Give up",
    youGotIt: "You got it!",
    youGaveUp: "You gave up",
    notValid: "That doesn't count",
    globalStats: "Today worldwide",
    successRate: "Success rate",
    firstToPlay: "You're the first today!",
    success: "got it",
    gotIt: "Got it",
    gaveUp: "Gave up",
    share: "Share your run",
    nextTomorrow: "New impossible word tomorrow",
    loginRequired: "Sign in to play the challenge",
  },

 ...
 * pointing at the retired Replit host must never make the canonical site
 * perform a cross-origin request that fails with CORS.
 */
export function getApiUrl(): string {
  ...
  if (configured) {
    try {
      ...
      // Malformed environment value: safe fallback is same-origin.
    }
  }
...
export const AVATAR_COLORS = [
  "#b5301a", "#1a237e", "#f9a825", "#2e7d32", "#8e24aa",
  "#0097a7", "#e64a19", "#37474f", "#ad1457", "#00838f",
];

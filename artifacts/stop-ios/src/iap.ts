 ...
 *
 * Product IDs are intentionally kept separate from the Google Play SKUs used
 * by the web/TWA client. They can be created in App Store Connect without
 * changing the rest of the STOP product catalogue.
 */
...
/**
 * Backend route names reserved for server-side App Store transaction
 * verification. The server must verify the signed Apple transaction before
 * granting Premium or the World Cup cosmetics.
 */

...
export default function App() {
  ...
  if (screen === "shop") {
    if (!session) return <SafeAreaView style={styles.safeArea}><View style={styles.center}><Text style={styles.emoji}>🛍️</Text><Text style={styles.heading}>Tienda</Text><Text style={styles.body}>Inicia sesión para consultar tu colección y comprar cosméticos.</Text><TouchableOpacity style={styles.primary} onPress={() => setScreen("home")}><Text style={styles.primaryText}>Volver al inicio</Text></TouchableOpacity></View><StatusBar style="auto" /></SafeAreaView>;
    return <ShopScreen session={session} onExit={() => setScreen("home")} />;
  }
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        {session && <TouchableOpacity style={styles.shopCard} onPress={() => setScreen("shop")} activeOpacity={0.85}><Text style={styles.cardEmoji}>🛍️</Text><View style={styles.cardContent}><Text style={styles.shopTitle}>Tienda</Text><Text style={styles.shopText}>Pack Mundial y tus cosméticos</Text></View><Text style={styles.arrowDark}>›</Text></TouchableOpacity>}
        ...
        <View style={styles.bottomNav}><NavButton label="Inicio" active onPress={() => setScreen("home")} /><NavButton label="Jugar" active={false} onPress={() => setScreen("play")} /><NavButton label="Tienda" active={false} onPress={() => setScreen("shop")} /><NavButton label="Perfil" active={false} onPress={() => setScreen("profile")} /></View>

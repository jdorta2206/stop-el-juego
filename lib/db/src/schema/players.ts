...
export const playerScoresTable = pgTable("player_scores", {
  ...
  // Optional cosmetic background. Kept nullable for compatibility with
  // existing players; the API falls back gracefully if an older database has
  // not yet received the corresponding migration.

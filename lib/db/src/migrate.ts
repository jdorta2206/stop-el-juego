...
export async function ensureIndexes(): Promise<void> {
  const stmts = [
    ...
    `ALTER TABLE follows ADD COLUMN IF NOT EXISTS followed_provider text`,
    ...
    `CREATE TABLE IF NOT EXISTS play_purchase_ledger (id serial PRIMARY KEY, purchase_token text NOT NULL UNIQUE, player_id text NOT NULL, product_id text NOT NULL, created_at timestamp NOT NULL DEFAULT NOW())`,
    `CREATE INDEX IF NOT EXISTS play_purchase_ledger_player_id_idx ON play_purchase_ledger (player_id)`,
